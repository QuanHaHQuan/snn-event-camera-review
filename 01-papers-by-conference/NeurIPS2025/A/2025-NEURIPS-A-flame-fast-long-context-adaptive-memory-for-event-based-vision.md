...
检索命中关键词：event camera data; event streams; LIF。自动分类理由：Official abstract confirms event camera
data/event streams and a LIF-based neuro-inspired feature extractor.。 备注：Track: Main
Conference Track. Official abstract/page inspected under broad high-recall title workflow.。
