...
EBHNet and the EBH dataset use real event streams to recover 3D hand sequences from blurred images. This is non-spiking task/dataset background outside Survey Core.

## Advisor Role

The hand-motion benchmark is adjacent task evidence, not a SECNet representation or Fourier/SNN mechanism.
