...
Bio-inspired Spiking Neural Networks (SNNs) provide an energy-efficient way to extract 3D
spatio-temporal features.

## Core Method

However, existing 3D SNNs have struggled with long-range dependencies until the recent
emergence of Mamba, which offers superior computational efficiency and sequence modeling
capability.
...
检索命中关键词：spiking neural network; spiking point。自动分类理由：Official abstract/page confirms
