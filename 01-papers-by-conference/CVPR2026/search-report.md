...
| CVPR2026-3561 | DarkShake-DVS: Event-based Human Action Recognition under Low-light and Shaking Camera Conditions | background | discussion |
...
| CVPR2026-0439 | RE-VLM: Event-Augmented Vision-Language Model for Scene Understanding | exclude | watch |
| CVPR2026-3426 | Reconstructing Spiking Neural Networks Using a Single Neuron with Autapses | background | watch |
