...
development of Artificial Intelligence due to their brain-inspired and energy-efficient
properties.

## Core Method

Compared to vanilla Spatial-Temporal Back-propagation (STBP) training methods, online
training can effectively avoid the risk of GPU memory explosion.
...
检索命中关键词：spiking neural network; surrogate gradient; LIF。自动分类理由：Official abstract/page
