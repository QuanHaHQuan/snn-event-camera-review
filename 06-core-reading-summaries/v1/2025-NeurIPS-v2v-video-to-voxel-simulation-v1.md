...
source_card: "01-papers-by-conference/NeurIPS2025/B/2025-NEURIPS-B-v2v-scaling-event-based-vision-through-efficient-video-to-voxel-simulation.md"
official_page: "https://papers.nips.cc/paper_files/paper/2025/hash/b14cf0a01f7a8b9cd3e365e40f910272-Abstract-Conference.html"
pdf_link: "https://arxiv.org/pdf/2505.16797"
local_pdf_status: "downloaded"
status: "auto-generated; needs human review"
tags: ["event camera"]
---

# Summary V1｜V2V: Scaling Event-Based Vision through Efficient Video-to-Voxel Simulation

## 1. One-sentence Summary

本文围绕 V2V: Scaling Event-Based Vision through Efficient Video-to-Voxel Simulation，基于论文 PDF 中的方法与实验描述，总结其在 event-camera 背景方向 的主要问题、方法和证据。
...
To address this challenge, we introduce Video-to-Voxel (V2V), an approach that directly converts conventional video frames into event-based voxel grid representations, bypassing the storage-intensive event stream generation entirely. V2V enables a 150× reduction in storage requirements while supporting on-the-fly parameter randomization for enhanced model robustness.
...
- scarcity of real data prevent event-based training datasets from scaling up, limiting
- revolutionized frame-based computer vision through decades of dataset collection and massive
- repositories like ImageNet [4], COCO [19], and WebVid [2], event camera data remains scarce and
- Standard video datasets typically have frame rates of around 30 per second (FPS), providing temporal
- Figure 1: The Video-to-V oxel (V2V) approach enables our training dataset to have more diversity
- demonstrate better reconstruction quality, indicated by higher SSIM (structural similarity, averaged
- over HQF [32] and EV AID [6]) on real-world test datasets.
- sequence from the ESIM-280 dataset occupies approximately 1GB. If we were to scale to 10,000

本 V1 只引用这些可从 PDF 抽取到的实验线索；完整数值、baseline 顺序和显著性比较需要人工在 V2 中逐表核对。

## 7. Main Contributions

1. 提出或系统化研究了与 `V2V: Scaling Event-Based Vision through Efficient Video-to-Voxel Simulation` 对应的核心方法/任务设定。
...
- Local PDF parsed successfully: 2025-NeurIPS-v2v-scaling-event-based-vision-through-efficient-video-to-voxel-simulation.pdf, 23 pages.
- PDF headings observed: Abstract; 1 Introduction; Videos; Samples; Variants; Scenes; Data Preparation; Training.
- PDF key experiment/evidence lines include datasets/metrics/table mentions listed in Section 6.

## 14. Draft Survey-Usable Sentences

Draft material: `V2V: Scaling Event-Based Vision through Efficient Video-to-Voxel Simulation` can be cited cautiously as B: Event Camera side background evidence after its quantitative tables and method details are manually verified.
