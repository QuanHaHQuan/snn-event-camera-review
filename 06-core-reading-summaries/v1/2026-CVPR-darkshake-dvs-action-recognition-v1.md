...
source_card: "01-papers-by-conference/CVPR2026/B/2026-CVPR-B-darkshake-dvs-event-based-human-action-recognition-under-low-light-and-shaking-camera-cond.md"
...
1. 提出或系统化研究了与 `DarkShake-DVS: Event-based Human Action Recognition under Low-light and Shaking Camera Conditions` 对应的核心方法/任务设定。
...
- Local PDF parsed successfully: 2026-CVPR-darkshake-dvs-event-based-human-action-recognition-under-low-light-and-shaking-camera-cond.pdf, 11 pages.
- PDF headings observed: Shaking Camera Conditions; Abstract; 1. Introduction; Clear Input; 2. Related Work; 3. The DarkShake-DVS Dataset; Event StreamIMU; Event Frame.
- PDF key experiment/evidence lines include datasets/metrics/table mentions listed in Section 6.

## 14. Draft Survey-Usable Sentences

Draft material: `DarkShake-DVS: Event-based Human Action Recognition under Low-light and Shaking Camera Conditions` can be cited cautiously as B: Event Camera side background evidence after its quantitative tables and method details are manually verified.
